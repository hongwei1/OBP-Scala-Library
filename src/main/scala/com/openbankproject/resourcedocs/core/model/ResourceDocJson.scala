...
/**
 * JSON-friendly DTO for API resource documentation.
 * This structure avoids framework types and uses primitive-friendly fields.
 */
...
/**
 * Extended JSON-friendly DTO for API resource documentation that matches OBP-API structure.
 * This structure includes all fields from OBP-API's ResourceDocJson for compatibility.
 * Field names use snake_case to match OBP-API's ResourceDocJson structure. */
